// --створити масив з: // - та вивести його в консоль
...
// let mix = ['1', '1', '1', '1', '1', 1, 2, 3, 4, 5, true, false];
// console.log(mix)
...
// let arr = [1, 2, 3, '4', '5', true, '7', '8', 9, false];
// for (let i = 0; i < arr.length; i++) {
//     console.log(arr[i])
// }
...
//     let currentGenresCount = currentBook.genres.length;
//
//     if (currentGenresCount > maxGenresCount) {
//         maxGenresCount = currentGenresCount;
//         booksWithMaxGenres = [currentBook];
//     } else if (currentGenresCount === maxGenresCount) {
//         booksWithMaxGenres.push(currentBook);
//     }
// }
//
// for (let i = 0; i < booksWithMaxGenres.length; i++) {
//     console.log(booksWithMaxGenres[i].title);
// }

// - знайти книжку/ки з найдовшою назвою

// let longestTitle = books[0].title;
//
...
// let booksWithOneAuthors = [];
//
// for (let i = 0; i < books.length; i++) {
//     if (books[i].authors.length === 1) {
//         booksWithOneAuthors.push(books[i]);
//     }
// }
